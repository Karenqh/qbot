package nanqineveryday.qbot.ioio.util;
...
public class Constants {
    ...
    public static final String CALL_USER    = "nanqineveryday.qbot.ioio.SHARED_PREFS.CALL_USER";
    ...
    public static final String SUB_KEY = "sub-c-db247f12-d42b-11e5-8a35-0619f8945a4f"; // Your Sub Key
